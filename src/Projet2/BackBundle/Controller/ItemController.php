...
use Projet2\BackBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BackBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("BackBundle:Item:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BackBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BackBundle:Item:edit.html.twig")
     */
